 ...
 **************************************************/
void EMHome::gbCnf::cnvVec2Mat(const vector<double>& v, Config& c) {
  c.bvx[0] = v[0];
  c.bvy[0] = v[1] * cos(v[5]);
  c.bvy[1] = v[1] * sin(v[5]);
  c.bvz[0] = v[2] * cos(v[4]);
 ...
 **************************************************/
void EMHome::gbCnf::cnvMat2Vec(Config& c) {
 ...
 * 0  1  2  3  4  5
 **************************************************/
vector<double> EMHome::gbCnf::cnvVecXY2VecAng(const vector<double>& v) {
 ...
 **************************************************/
Config EMHome::gbCnf::readLmpData(const string& fname) {
